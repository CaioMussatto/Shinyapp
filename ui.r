...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    tabItems(
      tabItem("data",
              fluidRow(
                box(title = "Heatmap", width = 5, solidHeader = TRUE, status = "primary",
                    plotOutput("heatmap", height  = "900px", width = "575px")
                ),
                box(title = "Select the Cell lines to display", width = 5, solidHeader = TRUE, status = "primary",
                    selectizeInput(
                      inputId = "filter", 
                ...
                box(title = "Table", width = 5, solidHeader = TRUE, status = "primary",
                    column(width = 6,
      ...
      tabItem(tabName = "enrichr",
              fluidRow(
                box(title = "Enrichr plot", width = 6, solidHeader = TRUE, status = "primary",
                    plotOutput("enrichr_plot", height = "550px", width = "600px")),
                box(title = "Dataframe used", width = 5, solidHeader = T, status = "primary",
                    column(width = 6,
                           downloadButton("download_enrichr", "Download Table")),
                    dataTableOutput("tabela_enrichr")),
                box(title = "Genes used", width = 5, solidHeader = TRUE, status = "primary",
